...
CREATE TABLE `kkpay_order`  (
  ...
  `fee_amount` decimal(11, 2) NULL DEFAULT NULL COMMENT '平台手续费金额',
...
CREATE TABLE `kkpay_payment_channel`  (
  ...
  `costs` decimal(5, 4) NOT NULL DEFAULT 0.0000 COMMENT '费率成本',
  `fixed_costs` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '固定成本',
  `rate` decimal(5, 4) NOT NULL DEFAULT 0.0000 COMMENT '费率',
  `fixed_fee` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '固定手续费',
  `min_fee` decimal(12, 2) NULL DEFAULT NULL COMMENT '最低手续费',
  `max_fee` decimal(12, 2) NULL DEFAULT NULL COMMENT '最高手续费',
